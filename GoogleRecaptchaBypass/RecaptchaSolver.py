...
class RecaptchaSolver:
    ...
    def solveCaptcha(self) -> None:
        ...
        # Handle main reCAPTCHA iframe (skip for invisible recaptcha)
        try:
            ...
            print("  [CAPTCHA] Invisible reCAPTCHA or checkbox not found, proceeding to challenge...")
    ...
    def is_solved(self) -> bool:
        ...
        try:
            # Check if challenge iframe is gone/hidden (invisible reCAPTCHA solved)
            iframe = self.driver.ele("xpath://iframe[contains(@title, 'recaptcha')]", timeout=self.TIMEOUT_SHORT)
